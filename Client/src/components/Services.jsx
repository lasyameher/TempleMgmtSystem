  ...
  return (
    <div className="bg-orange-300 min-h-screen">
      ...
      <div className="mt-10 ml-10 max-w-5xl bg-orange-100 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <a href="#">
          <h5 className="mb-2 text-1xl font-bold px-2 py-1 bg-orange-400 rounded-t-lg tracking-tight text-gray-900 dark:text-white">Special Events Services</h5>
        </a>
        <p className="text-gray-500 px-2 dark:text-gray-400">
          Special Events Calendar can be found{" "}
          <a href="/Calendar" className="font-medium text-blue-600 underline dark:text-blue-500 hover:no-underline">here</a>{" "}
        </p>
        <br></br>
        <h6 className="text-1xl font-bold px-1 dark:text-white">"By Request" Services:</h6>
        <ul className="mb-3 px-4 font-normal text-gray-700 list-disc dark:text-gray-400">
        ...
        <p className="text-gray-500 px-2 dark:text-gray-400">
          For Scheduling{" "}
          <a href="/Login" className="font-medium text-blue-600 underline dark:text-blue-500 hover:no-underline">Login</a>{" "}
        </p>
        <br></br>
        <h6 className="text-1xl px-2 font-bold dark:text-white">Yantra Pooja:</h6>
        <p className="text-gray-500 px-4 dark:text-gray-400">
          A very special service that is performed in honor of the{" "}
          <a href="https://en.wikipedia.org/wiki/Yantra" className="font-medium text-blue-600 underline dark:text-blue-500 hover:no-underline">Yantras</a>{" "}
          (WikiLink).
        </p>
      ...
      <div className="absolute top-52 right-0 h-96 mt-0 mr-8">
        <div className="max-w-sm max-h-xl mx-10 bg-orange-100 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 ml-auto">
          <a href="#">
            <h1 className="text-1xl flex-center px-4 py-2 bg-orange-400 rounded-t-lg font-bold mt-12 ml-0">Signup for Omkar Temple's Newsletter</h1>
          </a>
          <br></br>
